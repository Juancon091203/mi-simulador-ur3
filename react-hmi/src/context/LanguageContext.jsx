...
const translations = {
  es: {
    ...
    execute_preview_photos: "Ejecutar fotos de pre-inspección",
    execute_preview_photos_desc: "Realizar capturas preliminares de pre-inspección antes del escaneado completo",
    cancel: "Cancelar",
    next_tab: "Siguiente",
  ...
  en: {
    ...
    execute_preview_photos: "Execute pre-inspection photos",
    execute_preview_photos_desc: "Perform preliminary pre-inspection captures before full scan",
    cancel: "Cancel",
    next_tab: "Next",
